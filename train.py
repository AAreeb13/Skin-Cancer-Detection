...
class CNN(nn.Module):
    def __init__(self):
        ...
        # Hardcoded size for the fully connected layer
        # self.linear = nn.Linear(1024, 1)  # Update this value based on your actual feature map size
        self.linear = nn.Linear(128 * 8 * 8, 1) # 3 layer
        # self.linear = nn.Linear(32 * 74 * 74, 1)  # 1 layer
        # self.linear = nn.Linear(64 * 24 * 24, 1)  # 2 layer
    ...
    def predict(self, X):
        ...
        with torch.no_grad():
            ...
            return (outputs > self.threshold).int()  # Convert to binary (0 or 1)
...
if __name__ == '__main__':
    ...
    for epoch in range(epochs):
        ...
        model.training_loss.append(epoch_loss)
        ...
        with torch.no_grad():
            for inputs, labels in dataloaders['validate']:
                ...
                preds = (torch.sigmoid(outputs) > model.threshold).int()
        ...
        model.validation_loss.append(avg_val_loss)
    ...
    print("Training Losses:", model.training_loss)
    print("Validation Losses:", model.validation_loss)
